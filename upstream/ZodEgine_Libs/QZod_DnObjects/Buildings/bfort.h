...
#include "../Gw/gwproduction.h"


class QZOD_DNOBJECTSSHARED_EXPORT BFort : public ZBuilding
{
	public:
		BFort(ZTime *ztime_, ZSettings *zsettings_ = nullptr, planet_type palette_ = DESERT, bool is_front_ = true);
...
// 		SDL_Surface *GetRender();
		...
		bool NeedsAfterEffects() const { return true; }
		int Process();
