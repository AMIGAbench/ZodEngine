...
void ZRobot::Init()
{
	...
	for(i=1;i<MAX_TEAM_TYPES;i++)
	{
		for(j=0;j<MAX_ANGLE_TYPES;j++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/stand_%s_r%03d.png", team_type_string[i].c_str(), ROTATION[j]);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/point_%s_r%03d.png", team_type_string[i].c_str(), ROTATION[j]);
			...
			for(k=0;k<2;k++)
			{
				snprintf(filename_c, sizeof(filename_c), "assets/units/robots/dodge_%s_r%03d_n%02d.png", team_type_string[i].c_str(), ROTATION[j], k);
			...
			for(k=0;k<4;k++)
			{
				snprintf(filename_c, sizeof(filename_c), "assets/units/robots/throw_%s_r%03d_n%02d.png", team_type_string[i].c_str(), ROTATION[j], k);
			...
			for(k=0;k<5;k++)
			{
				snprintf(filename_c, sizeof(filename_c), "assets/units/robots/enter_apc_%s_r%03d_n%02d.png", team_type_string[i].c_str(), ROTATION[j], k);
			...
			for(k=0;k<4;k++)
			{
				snprintf(filename_c, sizeof(filename_c), "assets/units/robots/walk_%s_r%03d_n%02d.png", team_type_string[i].c_str(), ROTATION[j], k);
			...
			for(k=0;k<3;k++)
			{
				snprintf(filename_c, sizeof(filename_c), "assets/units/robots/look_around_%s_r%03d_n%02d.png", team_type_string[i].c_str(), ROTATION[j], k);
		...
		for(k=0;k<9;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/beat_ground_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<10;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/beer_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<4;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/celebrate_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<11;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/cigarette_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<2;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/confused_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<8;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/escape_tank_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<12;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/full_area_scan_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<11;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/head_stretch_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<5;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/jump-up_%s_n%02d.png", team_type_string[i].c_str(), k);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/jump-down_%s_n%02d.png", team_type_string[i].c_str(), k);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/jump-left_%s_n%02d.png", team_type_string[i].c_str(), k);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/jump-right_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<4;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/pickup-down_%s_n%02d.png", team_type_string[i].c_str(), k);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/pickup-up_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<17;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/pope_%s_n%02d.png", team_type_string[i].c_str(), k);
		...
		for(k=0;k<5;k++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/robots/praise_the_lord_%s_n%02d.png", team_type_string[i].c_str(), k);
...
{ 
	...
	{
		ZLOG("ZRobot::SetGrenadeAmount: had to adjust bad value:%d\n", grenade_amount);
		grenade_amount = 0;
	}
}
