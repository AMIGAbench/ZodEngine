...
extern const string hut_animal_type_string[MAX_HUT_ANIMAL_TYPES];
...
class QZOD_DNOBJECTSSHARED_EXPORT hut_animal_graphics
{
public:
...
class QZOD_DNOBJECTSSHARED_EXPORT AHutAnimal : public ZObject
{
public:
	AHutAnimal(ZTime *ztime_, ZSettings *zsettings_ = nullptr, int palette_ = DESERT);
