...
class QZOD_DNOBJECTSSHARED_EXPORT VCrane : public ZVehicle
{
	public:
		VCrane(ZTime *ztime_, ZSettings *zsettings_ = nullptr);
		~VCrane();
...
// 		SDL_Surface *GetRender();
		...
		void DoCraneAnim(bool on_, ZObject *rep_obj = nullptr);
	private:
