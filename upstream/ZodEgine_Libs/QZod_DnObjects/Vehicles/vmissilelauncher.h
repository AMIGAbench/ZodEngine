#ifndef VMISSILELAUNCHER_H
#define VMISSILELAUNCHER_H

#include "zvehicle.h"

class QZOD_DNOBJECTSSHARED_EXPORT VMissileLauncher : public ZVehicle
{
	public:
		VMissileLauncher(ZTime *ztime_, ZSettings *zsettings_ = nullptr);
