...
void ZCursor::Init()
{
	...
	for(j=0;j<4;j++)
	{
		snprintf(filename_c, sizeof(filename_c), "assets/cursors/cursor_null_n%02d.png", j);
		cursor[CURSOR_C][0][j].LoadBaseImage(filename_c);

		snprintf(filename_c, sizeof(filename_c), "assets/cursors/placed_n%02d.png", j);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/cursors/attacked_n%02d.png", j);
		temp_surface = IMG_Load(filename_c);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/cursors/grabbed_n%02d.png", j);
		temp_surface = IMG_Load(filename_c);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/cursors/grenaded_n%02d.png", j);
		temp_surface = IMG_Load(filename_c);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/cursors/repaired_n%02d.png", j);
		temp_surface = IMG_Load(filename_c);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/cursors/entered_n%02d.png", j);
		temp_surface = IMG_Load(filename_c);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/cursors/exited_n%02d.png", j);
		temp_surface = IMG_Load(filename_c);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/cursors/cannoned_n%02d.png", j);
		temp_surface = IMG_Load(filename_c);
	...
	for(i=1;i<MAX_TEAM_TYPES;i++)
		for(j=0;j<4;j++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/cursor_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/place_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/attack_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/grab_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/grenade_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/repair_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/nono_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/cannon_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/enter_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/cursors/exit_%s_n%02d.png", team_type_string[i].c_str(), j);
...
void ZCursor::Render(ZMap &the_map, SDL_Surface *dest, int &x, int &y, bool restrict_to_map)
{
	...
	else
	{
		...
		current_surface->BlitSurface(nullptr, &to_rect);
		//SDL_BlitSurface( current_surface, nullptr, dest, &to_rect);
	}
}
