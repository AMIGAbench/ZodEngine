...
class QZOD_DNMAPSHARED_EXPORT ZMap
{
    public:
        ...
        /* Zonenmarker einmalig in die Kartenflaeche stempeln; erkennt den
         * Besitzerwechsel selbst. Wird aus DoZoneEffects gerufen. */
        void BakeZoneMarkers();
        void MarkerOpaqueBox(SDL_Surface *s, int &w, int &h);
        ...
        /* Verschiebung in gueltige Grenzen bringen. Ist die Karte schmaler
         * als der Ausschnitt, wird sie zentriert und shift_x ist NEGATIV --
         * Einzelheiten am Rumpf in qzod_map.cpp. */
        void ClampShift();
        bool ShiftViewRight();
        bool ShiftViewUp();
        bool ShiftViewDown();
    ...
    private:
        ...
        bool render_fail_reported; //Kartenflaeche nicht belegbar: nur einmal melden
        bool **stamp_list;
