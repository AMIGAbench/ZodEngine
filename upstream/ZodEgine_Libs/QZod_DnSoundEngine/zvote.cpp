...
void ZVote::DoRender(ZMap &the_map)
{
	if(in_progress && vote_in_progress_img.GetBaseSurface())
	{
       ...
       // !!TODO  ZSDL_Surface::SetAlpha(char alpha_), max value 127 .. < 200
