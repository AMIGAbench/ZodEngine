...
void ZSoundEngine::Init(ZMap *zmap_)
{
    ...
    for(i=0; i<5; i++)
    {
        //zweistellig wie im Original (%02d): die Dateien heissen
        //explosion_00.wav ... explosion_04.wav. std::to_string(i) erzeugte
        //explosion_0.wav und liess damit alle Explosionsklaenge fehlschlagen.
        char num[3];
        num[0] = (char)('0' + (i / 10));
        num[1] = (char)('0' + (i % 10));
        num[2] = 0;
    ...
    {       
        //zweistellig wie im Original (%02d): comp_youre_losing_00.wav ...
        char num[3];
        num[0] = (char)('0' + (i / 10));
        num[1] = (char)('0' + (i % 10));
        num[2] = 0;
