...
extern const string gmm_event_type_string[MAC_GMM_EVENTS];
...
extern const string mmwidget_type_string[MAX_MMWIDGETS];
...
extern const string mmbutton_type_string[MAX_MMBUTTON_TYPES];
...
extern const string gmm_main_menu_button_string[MAX_GMMMM_BUTTONS];
