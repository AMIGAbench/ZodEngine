...
void ECraneConco::Init()
{
	...
	for(i=1;i<MAX_TEAM_TYPES;i++)
	{
		for(j=0;j<8;j++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/conco_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/sign_flip_%s_n%02d.png", team_type_string[i].c_str(), j);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/sign_%s.png", team_type_string[i].c_str());
		//sign[i].LoadBaseImage(filename_c);// = IMG_Load_Error(filename_c);
		ZTeam::LoadZSurface(i, sign[ZTEAM_BASE_TEAM], sign[i], filename_c);

		snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/cone_no_shadow_%s.png", team_type_string[i].c_str());
		...
		snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/cone_%s.png", team_type_string[i].c_str());
		//cone[i].LoadBaseImage(filename_c);// = IMG_Load_Error(filename_c);
		ZTeam::LoadZSurface(i, cone[ZTEAM_BASE_TEAM], cone[i], filename_c);

		for(j=0;j<2;j++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/robot_jackhammer_%s_n%02d.png", team_type_string[i].c_str(), j);
			...
			snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/robot_paper_%s_n%02d.png", team_type_string[i].c_str(), j);
		...
		for(j=0;j<3;j++)
		{
			snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/robot_point_%s_n%02d.png", team_type_string[i].c_str(), j);
		...
		snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/robot_travel_left_%s.png", team_type_string[i].c_str());
		...
		snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/robot_travel_right_%s.png", team_type_string[i].c_str());
		...
		snprintf(filename_c, sizeof(filename_c), "assets/units/vehicles/crane/effects/robot_travel_updown_%s.png", team_type_string[i].c_str());
