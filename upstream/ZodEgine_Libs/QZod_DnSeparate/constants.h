...
extern const string planet_type_string[MAX_PLANET_TYPES];
...
extern const string robot_type_string[MAX_ROBOT_TYPES];

extern const string robot_production_string[MAX_ROBOT_TYPES];
...
extern const string cannon_type_string[MAX_CANNON_TYPES];

extern const string cannon_production_string[MAX_CANNON_TYPES];
...
extern const string vehicle_type_string[MAX_VEHICLE_TYPES];

extern const string vehicle_production_string[MAX_VEHICLE_TYPES];
...
extern const string building_type_string[MAX_BUILDING_TYPES];
...
extern const string item_type_string[MAX_ITEM_TYPES];
...
enum team_type
	...
	extern const string team_type_string[MAX_TEAM_TYPES];
#else
...
extern const string player_mode_string[MAX_PLAYER_MODES];
...
// TODO  move in zcore.h (original ZodEngine)
// --------------------------------------------------------------
enum p_vote_choice
{
    P_NULL_VOTE, P_YES_VOTE, P_NO_VOTE, P_PASS_VOTE, P_MAX_VOTE_CHOICES
};
class QZOD_DNSEPARATESHARED_EXPORT p_info
{
public:
    p_info()
    {
